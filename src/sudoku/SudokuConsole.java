 ...
 */
public class SudokuConsole implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        exec.execute(new SudokuConsole("./problem.txt", "./save.txt", "./solution.txt"));
    }
     ...
     */
    public SudokuConsole(String start, String load, String end) {
    ...
    public void run() {
        while (true) {
            ...
            System.out.println(" - Try to [simple]solve the Sudoku.");
            ...
            switch (in().toLowerCase()) {
                case "print":
                    ...
                    break;
                case "simple":
                    System.out.println("Simple Solve managed to fill out " + s.simpleSolve() + " fields");
                    break;
                case "get":
                    getChars();
                    break;
    ...
    public void getChars() {
        ...
        System.out.println(s.getFreeChars(row, col));
    }
    ...
    private void solution() {
        Sudoku solution = new Sudoku(solutionPath);
        solution.print();
    }
